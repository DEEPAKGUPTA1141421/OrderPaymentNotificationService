...
public record CreateOrderDto(
        ...
        @NotBlank(message = "Gateway name is required") @Pattern(regexp = "^(phonepe|razorpay|googlepay|cod)$", message = "Gateway must be one of: phonepe, razorpay, googlepay, cod") String gateway,
